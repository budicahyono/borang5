...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-plus-square fa-fw"></i>Form Tambah Pembimbingan Skripsi
		</div>
		...
		{!!Form::open(array('class' =>'form-horizontal line')) !!}
              <div class="box-body ">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
					<input name="lamaPenyelesaian" type="text" class="form-control" id="lamaPenyelesaian" placeholder="Silakan isi lama Penyelesaian disini" value="{{Input::old('lamaPenyelesaian')}}" />
                  </div>
