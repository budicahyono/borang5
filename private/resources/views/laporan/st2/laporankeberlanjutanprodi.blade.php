...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-file fa-fw"></i>Laporan Keberlanjutan Prodi
		</div>
		<p class="text-justify">Berikut merupakan laporan Keberlanjutan Program Studi.</p>
		<p></p>
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'cetakkeberlanjutanprodi','method' => 'post')) !!}
              <div class="box-body ">
