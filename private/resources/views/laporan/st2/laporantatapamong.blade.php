...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-file fa-fw"></i>Laporan Tata Pamong 
		</div>
		<p class="text-justify">Berikut merupakan laporan Tata Pamong</p>
		<p></p>
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'cetaktatapamong','method' => 'post')) !!}
              <div class="box-body ">
