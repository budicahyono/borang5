...
@section('content')
<?php 
if (Session::has('tab_sarana')) {
	$tab_sarana = Session::get('tab_sarana');
} else {
	$tab_sarana = "dosen";
}
?>	
<div class="row">
    ...
    <li class="<?php if ($tab_sarana == "dosen") echo 'active'; ?>"><a href="#tab1"><b>Ruang Kerja Dosen</b></a></li>
    <li class="<?php if ($tab_sarana == "prasarana") echo 'active'; ?>"><a href="#tab2"><b>Data Prasarana</b></a></li>
    <li class="<?php if ($tab_sarana == "penggunaan") echo 'active'; ?>"><a href="#tab3"><b>Data Denunjang</b></a></li>
    <li class="<?php if ($tab_sarana == "penelitian") echo 'active'; ?>"><a href="#tab4"><b>Pustaka</b></a></li>
    <li class="<?php if ($tab_sarana == "pengabdian") echo 'active'; ?>"><a href="#tab5"><b>Dana Kegiatan Pelayanan / PKM</b></a></li>

  </ul>
  <div class="tab-content"> 	
	<div id="tab1" class="tab-pane fade <?php if ($tab_sarana == "dosen") echo 'in active'; ?>">
	...
	<div id="tab2" class="tab-pane fade <?php if ($tab_sarana == "sumber") echo 'in active'; ?>">
		<div class="breadcrumb">
	...
	<div id="tab3" class="tab-pane fade <?php if ($tab_sarana == "penggunaan") echo 'in active'; ?>">
		<div class="breadcrumb">
	...
	<div id="tab4" class="tab-pane fade <?php if ($tab_sarana == "penelitian") echo 'in active'; ?>">
		<div class="breadcrumb">
	...
	<div id="tab5" class="tab-pane fade <?php if ($tab_sarana == "pengabdian") echo 'in active'; ?>">
		<div class="breadcrumb">
