...
<div class="row">
	<div class="col-lg-12 panjang">
		<h3 class="page-header">
			<b>Semua Standar Akademik</b> 
		</h3>
		<div class="breadcrumb">
			   <i class="fa fa-file fa-fw"></i>Laporan Semua Standar Akademik
		</div>
		<p class="text-justify">Berikut merupakan laporan Semua Standar dari Standar 1 sampai Standar 7 Akademik</p>
		<p></p>
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'cetakall','method' => 'post')) !!}
              <div class="box-body ">
