...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-edit fa-fw"></i>Form Edit Mahasiswa Non Reguler
		</div>		
		...
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'editmahasiswanonreg','method' => 'post')) !!}
              <div class="box-body ">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="mahasiswaBaruNonReguler" type="text" class="form-control" id="mahasiswaBaruNonReguler" placeholder="Silakan isi jumlah mahasiswa baru non reguler disini" value="{{$item->mahasiswaBaruNonReguler}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="totalMahasiswaNonReguler" type="text" class="form-control" id="totalMahasiswaNonReguler" placeholder="Silakan isi total mahasiswa reguler disini" value="{{$item->totalMahasiswaNonReguler}}" />
                  </div>
