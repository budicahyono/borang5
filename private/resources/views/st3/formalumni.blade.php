...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-plus-square fa-fw"></i>Form Tambah Alumni
		</div>		
              ...
              <div class="box-body ">
				...
				<div class="form-group">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
						<input name="waktuTungguLulusan" type="text" class="form-control" id="waktuTungguLulusan" placeholder="Silakan isi waktu tunggu lulusan dalam bulan" value="{{Input::old('waktuTungguLulusan')}}" />
                  </div>
				...
				<div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
						<input name="kerjaSesuaiBidang" type="text" class="form-control" id="kerjaSesuaiBidang" placeholder="Silakan isi Kerja Sesuai Bidang dalam persentase" value="{{Input::old('kerjaSesuaiBidang')}}" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                     <textarea name="himpunanAlumni" class="form-control ckeditor" id="himpunanAlumni" placeholder="Silakan isi penjelasan himpunan alumni disini">{{Input::old('himpunanAlumni')}}</textarea>
                  </div>
