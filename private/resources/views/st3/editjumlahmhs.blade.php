...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-edit fa-fw"></i>Form Edit Jumlah Mahasiswa
		</div>		
		...
		<p></p>
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'editjumlahmhs','method' => 'post')) !!}
              <div class="box-body ">
				@foreach($jumlahmhs as $item)
                ...
                <div class="form-group ">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
						<input name="angkatan" type="text" class="form-control" id="angkatan" placeholder="Silakan isi angkatan disini" value="{{$item->angkatan}}" />
                  </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
						<input name="tahunAkademikBerjalan" type="text" class="form-control" id="tahunAkademikBerjalan" placeholder="Silakan isi tahun akademik berjalan disini" value="{{$item->tahunAkademikBerjalan}}" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="jumlah" type="text" class="form-control" id="jumlah" placeholder="Silakan isi jumlah mahasiswa disini" value="{{$item->jumlah}}" />
                  </div>
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="jumlahLulusan" type="text" class="form-control" id="jumlah" placeholder="Silakan isi jumlah lulusan disini" value="{{$item->jumlahLulusan}}" />
                  </div>
