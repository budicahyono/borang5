...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-edit fa-fw"></i>Form Edit Mahasiswa Reguler
		</div>		
		...
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'editmahasiswareg','method' => 'post')) !!}
              <div class="box-body ">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="dayaTampung" type="text" class="form-control" id="dayaTampung" placeholder="Silakan isi daya tampung disini" value="{{$item->dayaTampung}}" />
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="calonMahasiswaIkut" type="text" class="form-control" id="calonMahasiswaIkut" placeholder="Silakan isi jumlah calon mahasiswa terdaftar disini" value="{{$item->calonMahasiswaIkut}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="calonMahasiswaLulus" type="text" class="form-control" id="calonMahasiswaLulus" placeholder="Silakan isi jumlah calon mahasiswa lulus disini" value="{{$item->calonMahasiswaLulus}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="mahasiswaBaruReguler" type="text" class="form-control" id="mahasiswaBaruReguler" placeholder="Silakan isi jumlah mahasiswa baru reguler disini" value="{{$item->mahasiswaBaruReguler}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="mahasiswaBaruTransfer" type="text" class="form-control" id="mahasiswaBaruTransfer" placeholder="Silakan isi jumlah mahasiswa baru transfer disini" value="{{$item->mahasiswaBaruTransfer}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="totalMahasiswaReguler" type="text" class="form-control" id="totalMahasiswaReguler" placeholder="Silakan isi total mahasiswa reguler disini" value="{{$item->totalMahasiswaReguler}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="totalMahasiswaTransfer" type="text" class="form-control" id="totalMahasiswaTransfer" placeholder="Silakan isi total mahasiswa transfer disini" value="{{$item->totalMahasiswaTransfer}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="mahasiswaLulusReguler" type="text" class="form-control" id="mahasiswaLulusReguler" placeholder="Silakan isi jumlah mahasiswa lulus reguler disini" value="{{$item->mahasiswaLulusReguler}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="mahasiswaLulusTransfer" type="text" class="form-control" id="mahasiswaLulusTransfer" placeholder="Silakan isi jumlah mahasiswa lulus transfer disini" value="{{$item->mahasiswaLulusTransfer}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="ipkLulusMinimum" type="text" class="form-control" id="ipkLulusMinimum" placeholder="Silakan isi IPK lulus minimum disini" value="{{$item->ipkLulusMinimum}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="ipkLulusRerata" type="text" class="form-control" id="ipkLulusRerata" placeholder="Silakan isi IPK lulus rata-rata disini" value="{{$item->ipkLulusRerata}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="ipkLulusMaksimum" type="text" class="form-control" id="ipkLulusMaksimum" placeholder="Silakan isi IPK lulus maksimum disini" value="{{$item->ipkLulusMaksimum}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="persenIPK1" type="text" class="form-control" id="persenIPK1" placeholder="Silakan isi Persentase Lulusan Reguler dengan IPK < 2.75" value="{{$item->persenIPK1}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="persenIPK2" type="text" class="form-control" id="persenIPK2" placeholder="Silakan isi Persentase Lulusan Reguler dengan IPK  2.75 - 3.00" value="{{$item->persenIPK2}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-8 nopad-right" >
                    <input name="persenIPK3" type="text" class="form-control" id="persenIPK3" placeholder="Silakan isi Persentase Lulusan Reguler dengan IPK > 3.00" value="{{$item->persenIPK3}}" />
                  </div>
