...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-plus-square fa-fw"></i>Form Tambah Prestasi Dosen
		</div>		
		...
		{!!Form::open(array('class' =>'form-horizontal line')) !!}
              <div class="box-body ">
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9 nopad-right" >
					<input name="prestasi" type="text" class="form-control" id="prestasi" placeholder="Silakan isi prestasi disini" value="{{Input::old('prestasi')}}" />
                  </div>
				...
				<div class="form-group">
                  ...
                  <div class="col-sm-9 nopad-right" >
                    <input  name="waktu"  type="text" class="form-control datepicker" id="calendar" placeholder="Pilih Tanggal Prestasi" value="{{Input::old('waktu')}}" />
                  </div>
