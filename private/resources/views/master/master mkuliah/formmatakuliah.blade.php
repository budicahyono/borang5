...
@section('content')
	...
	{{Form::open(array('action' => 'MastermatakuliahController@save')) }}
	...
	{{Form::text ('idmatakuliah', '', array('class' =>'form-control')) }}

	{{Form::label ('namaMatakuliah', 'Nama Mata Kuliah') }}
	{{Form::text ('namaMataKuliah', '', array('class' =>'form-control')) }}

	{{Form::label ('jenisMataKuliah', 'Jenis Mata Kuliah') }}
	{{Form::text ('jenisMataKuliah', '', array('class' =>'form-control')) }}
	...
	{{Form::label ('sks', 'SKS') }}
	{{Form::text ('sks', '', array('class' =>'form-control')) }}

	{{Form::label ('sks_inti', 'SKS Inti') }}
	{{Form::text ('sks_inti', '', array('class' =>'form-control')) }}

	{{Form::label ('sks_institusi', 'SKS Institusi') }}
	{{Form::text ('sks_institusi', '', array('class' =>'form-control')) }}
	...
	{{Form::select ('sap',  array('Ada' => 'Ada', 'Tidak Ada' => 'Tidak Ada'), 
 		null, array('class' => 'form-control','placeholder'=>'Pilih SAP')) }}
