...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-edit fa-fw"></i>Form Edit Tatapamong
		</div>		
		<div class="form-group">	
			<a href="{{URL::to('tatapamong')}}" class="btn btn-info"><i class="fa fa-arrow-left fa-fw"></i>Back</a>
		</div>
		<p></p>
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'edittatapamong','method' => 'post')) !!}
              <div class="box-body ">
				@foreach($tatapamong as $item)
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 nopad-right" >
                    <textarea name="tataPamong" class="form-control ckeditor" id="tataPamong" placeholder="Silakan isi tatapamong disini">{{$item->tataPamong}}</textarea>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 nopad-right" >
                    <textarea name="kepemimpinan" class="form-control ckeditor" id="kepemimpinan" placeholder="Silakan isi kepemimpinan disini">{{$item->kepemimpinan}}</textarea>
                  </div>
               ...
               <div class="form-group text-justify">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 nopad-right" >
                    <textarea name="sistemPengelolaan" class="form-control ckeditor" id="sistemPengelolaan" placeholder="Silakan isi sistemPengelolaan disini">{{$item->sistemPengelolaan}}</textarea>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9 nopad-right" >
                    <textarea name="penjaminanMutu" class="form-control ckeditor" id="penjaminanMutu" placeholder="Silakan isi penjaminanMutu disini">{{$item->penjaminanMutu}}</textarea>
                  </div>
