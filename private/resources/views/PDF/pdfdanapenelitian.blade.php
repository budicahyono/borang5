<html>
	<head>
		...
		<title>Laporan Dana Penelitian</title>
		<body>
			<style type="text/css">
			...
			<div style="font-family:Arial; font-size:12px;">
				...
				<p align="justify">6.2.2  Tuliskan dana untuk kegiatan penelitian pada tiga tahun terakhir yang melibatkan dosen yang bidang keahliannya sesuai dengan program studi, dengan mengikuti format tabel berikut:	
			</div>
			<br>
			<table class="tg">
			  <tr>
