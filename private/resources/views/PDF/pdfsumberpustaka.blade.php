	...
	<head>
		...
		<title>Laporan Sumber Pustaka</title>
		<body>
			<style type="text/css">
			...
			<div style="font-family:Arial; font-size:12px;">
				...
				<p align="justify">6.4.2    Sebutkan sumber-sumber pustaka di lembaga lain (lembaga perpustakaan/ sumber dari internet beserta  alamat website) yang biasa diakses/dimanfaatkan oleh dosen dan mahasiswa program studi ini.	
			</div>
			<br>
			<table class="tg">
			  <tr>
