	...
	<head>
		...
		<body>
			...
			@if(Session::get('level')=='user')
				<p laign="justify">4.3.5  Tuliskan data aktivitas mengajar dosen tetap yang bidang keahliannya di luar PS,  dalam satu tahun akademik terakhir di PS ini dengan mengikuti format tabel berikut:
			</div>
			<br>
			<br>
			<table class="tg">
