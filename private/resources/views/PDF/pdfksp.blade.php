<html>
  <head>
    ...
    <title>Laporan Uapaya Peningkatan Suasana Akademik</title>
    <body>
      <style type="text/css">
      ...
      <div style="font-family:Arial; font-size:12px;">
			...
			@if(Session::get('level')=='user')
				<p align="justify">5.7.2	Ketersediaan dan jenis prasarana, sarana dan dana yang memungkinkan terciptanya interaksi akademik antara sivitas akademika.     
			<br>
			<br>
