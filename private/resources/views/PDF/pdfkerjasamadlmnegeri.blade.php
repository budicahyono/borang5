<html>
  <head>
    ...
    <title>Laporan Kerjasama Instansi Dalam Negeri</title>
    <body>
      <style type="text/css">
      ...
      <div style="font-family:Arial; font-size:12px;">
				...
				<br>
				<br>
				<p align="justify">7.3.1  Tuliskan instansi dalam negeri yang menjalin kerjasama* yang terkait dengan program studi/jurusan dalam tiga tahun terakhir.
