<html>
	<head>
		...
		<title>Laporan Prasarana Utama </title>
		<body>
			<style type="text/css">
      ...
      <div style="font-family:Arial; font-size:12px;">
				...
				<p align="justify">6.3.2   Tuliskan data prasarana (kantor, ruang kelas, ruang laboratorium, studio, ruang perpustakaan, kebun percobaan, dsb. kecuali  ruang dosen) yang dipergunakan PS dalam proses belajar mengajar dengan  mengikuti format tabel berikut:
			</div>
			<br>
			<table class="tg">
			  <tr>
