...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-folder-open fa-fw"></i>Form Lampiran Standar IV Pedoman SDM
		</div>
		<p>Silakan unggah lampiran dokumen pendukung Pedoman SDM </p>
              ...
              <div class="box-body ">
               ...
               <div class="form-group ">
                  ...
                  <div class="col-sm-9 nopad-right" >
					...
					<option value="sistem seleksi dan pengembangan "  <?php if (old("jenis_lampiran") == "sistem seleksi dan pengembangan ") echo 'selected="selected"' ?> > Sistem Seleksi dan Pengembangan </option> 		
					<option value="monitoring dan evaluasi"  <?php if (old("jenis_lampiran") == "monitoring dan evaluasi") echo 'selected="selected"' ?> >Monitoring dan Evaluasi</option> 		
				...
				<div class="form-group">
                  <div class="col-sm-3 nopad-left" >	
					@if($errors->has('pedoman_sdm'))
						<div class=" label  alert-danger text-capitalize"><i class="fa fa-exclamation-triangle fa-fw"></i>{{$errors->first('pedoman_sdm')}}</div>
				    @else 
                  ...
                  <div class="col-sm-9 nopad-right" >
						<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
							<div class="file-upload btn btn-block btn-primary">		
								...
								<input  id="uploadBtn" name="pedoman_sdm" type="file" class="upload" />
							</div>
						</div>
						<div class="col-xs-10" style="padding-left:0px;padding-right:0;">
							<input class="form-control" id="uploadFile" placeholder="Unggah File Max 10MB" value="{{Input::old('pedoman_sdm')}}" disabled />
						</div>
