...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-folder-open fa-fw"></i>Form Lampiran Standar IV Bukti Prestasi Dosen
		</div>
		<p>Silakan unggah lampiran bukti pencapaian prestasi / reputasi dosen</p>
		
		<div class="form-group">	
			<a href="{{URL::to('lampiran4')}}" class="btn btn-info"><i class="fa fa-arrow-left fa-fw"></i>Back</a>
		</div>
		<p></p>
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'addlampiranprestasidosen','method' => 'post','files' => 'true')) !!}
              <div class="box-body ">
				@foreach($tbprestasidosens as $item)
                ...
                <div class="form-group ">
				 ...
				 <div class="form-group ">
                  ...
                  <div class="col-sm-9 nopad-right" >
                   <input class="form-control" placeholder="" value="{{ $item->Tahun }}" disabled />
                  </div>
                </div>
				 ...
				 <div class="form-group ">
                  ...
                  <div class="col-sm-9 nopad-right" >
                   <input class="form-control" placeholder="" value="{{ $item->prestasi }}" disabled />
                  </div>
                </div>
				...
				<div class="form-group">
                  <div class="col-sm-3 nopad-left" >	
					@if($errors->has('bukti_prestasidosen'))
						<div class=" label  alert-danger text-capitalize"><i class="fa fa-exclamation-triangle fa-fw"></i>{{$errors->first('bukti_prestasidosen')}}</div>
				    @else 
                  ...
                  <div class="col-sm-9 nopad-right" >
						<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
							<div class="file-upload btn btn-block btn-primary">		
								...
								<input  id="uploadBtn" name="bukti_prestasidosen" type="file" class="upload" />
							</div>
						</div>
						<div class="col-xs-10" style="padding-left:0px;padding-right:0;">
							<input class="form-control" id="uploadFile" placeholder="Unggah File Max 10MB" value="{{Input::old('bukti_prestasidosen')}}" disabled />
						</div>
