...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-folder-open fa-fw"></i>Form Lampiran Standar III Layanan Mahasiswa
		</div>
		<p>Silakan unggah lampiran dokumen pendukung pelayanan kepada mahasiswa</p>
		...
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'addlampiranlayananmhs','method' => 'post','files' => 'true')) !!}
              <div class="box-body ">
				@foreach($tblayananmahasiswas as $item)
                ...
                <div class="form-group ">
				 ...
				 <div class="form-group ">
                  ...
                  <div class="col-sm-9 nopad-right" >
                   <textarea class="form-control ckeditor" placeholder="" id="isiKegiatan"  name="isiKegiatan" disabled >{!! $item->isiKegiatan !!}</textarea>
				...
				<div class="form-group">
                  <div class="col-sm-3 nopad-left" >	
					@if($errors->has('dokumen_layanan'))
						<div class=" label  alert-danger text-capitalize"><i class="fa fa-exclamation-triangle fa-fw"></i>{{$errors->first('dokumen_layanan')}}</div>
				    @else 
                  ...
                  <div class="col-sm-9 nopad-right" >
						<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
							<div class="file-upload btn btn-block btn-primary">		
								...
								<input  id="uploadBtn" name="dokumen_layanan" type="file" class="upload" />
							</div>
						</div>
						<div class="col-xs-10" style="padding-left:0px;padding-right:0;">
							<input class="form-control" id="uploadFile" placeholder="Unggah File Max 10MB" value="{{Input::old('dokumen_layanan')}}" disabled />
						</div>
