...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-folder-open fa-fw"></i>Form Lampiran Standar III Daftar Lulusan
		</div>
		<p>Silakan unggah lampiran daftar lulusan mahasiswa reguler dalam lima tahun terakhir (termasuk IPK).</p>
		...
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'addlampiranmhsreg','method' => 'post','files' => 'true')) !!}
              <div class="box-body ">
				@foreach($tbmhsregulers as $item)
                ...
                <div class="form-group ">
                  ...
                  <div class="col-sm-9 nopad-right" >
                   <input class="form-control" placeholder="" value="{{ $item->tahunAkademik }}" disabled />
				...
				<div class="form-group">
                  <div class="col-sm-3 nopad-left" >	
					@if($errors->has('daftar_lulusan'))
						<div class=" label  alert-danger text-capitalize"><i class="fa fa-exclamation-triangle fa-fw"></i>{{$errors->first('daftar_lulusan')}}</div>
				    @else 
                  ...
                  <div class="col-sm-9 nopad-right" >
						<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
							<div class="file-upload btn btn-block btn-primary">		
								...
								<input  id="uploadBtn" name="daftar_lulusan" type="file" class="upload" />
							</div>
						</div>
						<div class="col-xs-10" style="padding-left:0px;padding-right:0;">
							<input class="form-control" id="uploadFile" placeholder="Unggah File Max 10MB" value="{{Input::old('daftar_lulusan')}}" disabled />
						</div>
