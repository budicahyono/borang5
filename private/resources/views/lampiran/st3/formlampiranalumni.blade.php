...
<div class="row">
	<div class="col-lg-12 panjang">
		...
		<div class="breadcrumb">
			   <i class="fa fa-folder-open fa-fw"></i>Form Lampiran Standar III Laporan Alumni
		</div>
		<p>Silakan unggah laporan kegiatan himpunan alumni</p>
		...
		{!!Form::open(array('class' =>'form-horizontal line','url'=>'addlampiranalumni','method' => 'post','files' => 'true')) !!}
              <div class="box-body ">
				@foreach($tbalumnis as $item)
                ...
                <div class="form-group ">
                  ...
                  <div class="col-sm-9 nopad-right" >
                   <input class="form-control" placeholder="" value="{{ $item->waktuTungguLulusan }} Bulan" disabled />
                  </div>
                </div>
			  
				<div class="form-group">
                  <div class="col-sm-3 nopad-left" >	
					@if($errors->has('laporan_alumni'))
						<div class=" label  alert-danger text-capitalize"><i class="fa fa-exclamation-triangle fa-fw"></i>{{$errors->first('laporan_alumni')}}</div>
				    @else 
                  ...
                  <div class="col-sm-9 nopad-right" >
						<div class="col-xs-2" style="padding-right:15px;padding-left:0;">
							<div class="file-upload btn btn-block btn-primary">		
								...
								<input  id="uploadBtn" name="laporan_alumni" type="file" class="upload" />
							</div>
						</div>
						<div class="col-xs-10" style="padding-left:0px;padding-right:0;">
							<input class="form-control" id="uploadFile" placeholder="Unggah File Max 10MB" value="{{Input::old('laporan_alumni')}}" disabled />
						</div>
