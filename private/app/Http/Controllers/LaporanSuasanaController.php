...
class LaporanSuasanaController extends Controller {
	...
	public function index()
	{
		...
		$menu = "lap5"; //nama menu
		$menu2 = "laporansuasana"; //nama submenu
		return view('laporan.st5.laporansuasana', compact('masterprodis', 'menu','menu2','Akses','idprodi'));
