...
class LaporanprasaranaController extends Controller {
	...
	public function index()
	{
		...
		$menu = "lap6"; //nama menu
		$menu2 = "laporanprasarana"; //nama submenu
		return view('laporan.st6.laporanprasarana', compact('masterprodis', 'menu','menu2','Akses','idprodi'));
	...
	public function cetak()
	{
		...
		//return view('laporan.st6.cetakvisimisi', compact('tbvises','idprodi','title','prodi','filename'));
