...
class LaporanKurikulumController extends Controller {
	...
	public function index()
	{
		...
		$menu = "lap5"; //nama menu
		$menu2 = "laporankurikulum"; //nama submenu
		return view('laporan.st5.laporankurikulum', compact('masterprodis', 'menu','menu2','Akses','idprodi'));
	...
	public function cetak()
	{
		...
		//return view('laporan.st5.cetakvisimisi', compact('tbvises','idprodi','title','prodi','filename'));
