...
class LaporanpenelitianController extends Controller {
	...
	public function index()
	{
		...
		$menu = "lap7"; //nama menu
		$menu2 = "laporanpenelitian"; //nama submenu
		return view('laporan.st7.laporanpenelitian', compact('masterprodis', 'menu','menu2','Akses','idprodi'));
	...
	public function cetak()
	{
		...
		//return view('laporan.st7.cetakvisimisi', compact('tbvises','idprodi','title','prodi','filename'));
